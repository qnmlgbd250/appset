!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.0.1", ie: function () {
            ...
            if (r.path) {
                ...
                l.rel = "stylesheet", l.href = r.path + t, l.id = f, i("#" + f)[0] || o.appendChild(l), "function" == typeof n && function t() {
            ...
            return a ? layui.addcss("../../css/layer.css?v=" + r.v + i, e, t) : r.link("layer.css?v=" + r.v + i, e, t), this
            ...
            return l && (a = n), r.open(i.extend({
                ...
                anim: d
            } : (n = n || {}, (-1 === n.icon || n.icon === t && !o.config.skin) && (n.skin = c + " " + (n.skin || "layui-layer-hui")), n)))
        }, load: function (e, t) {
    ...
    s.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], l.pt.config = {
        ...
        if (!i("#" + t.id)[0]) {
            switch ("string" == typeof t.area && (t.area = "auto" === t.area ? ["", ""] : [t.area, ""]), t.shift && (t.anim = t.shift), 6 == r.ie && (t.fixed = !1), t.type) {
                case 0:
                    ...
                    break;
                case 2:
                    l = t.content = f ? t.content : [t.content || "http://layer.layui.com", "auto"], t.content = '<iframe scrolling="' + (t.content[1] || "auto") + '" allowtransparency="true" id="' + s[4] + a + '" name="' + s[4] + a + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + t.content[0] + '"></iframe>';
                    break;
                case 3:
            ...
            e.vessel(f, function (n, r, d) {
                c.append(n[0]), f ? 2 == t.type || 4 == t.type ? i("body").append(n[1]) : l.parents("." + s[0])[0] || (l.data("display", l.css("display")).show().addClass("layui-layer-wrap").wrap(n[1]), i("#" + s[0] + a).find("." + s[5]).before(r)) : c.append(n[1]), i(".layui-layer-move")[0] || c.append(o.moveElem = d), e.layero = i("#" + s[0] + a), t.scrollbar || s.html.css("overflow", "hidden").attr("layer-full", a)
        ...
        return t.move && s.css("cursor", "move"), s.on("mousedown", function (e) {
            ...
            t.resize && c.resizeStart && (a = i.clientX - c.offset[0], o = i.clientY - c.offset[1], i.preventDefault(), r.style(e.index, {
                width: c.area[0] + a,
                height: c.area[1] + o
            }), c.isResize = !0)
        ...
        1 == a.type && "" != a.area[1] && parseInt(a.area[1]) >= window.innerHeight ? ($(n.selector).css({
            height: window.innerHeight,
            top: 0
        }), console.log($(n.selector)), $(n.selector).find(".bt-w-menu").css({height: parseInt(a.area[1]) - 42}), $(n.selector).find(".layui-layer-close").removeClass("layui-layer-close2").addClass("layui-layer-close1"), $(n.selector).find(".layui-layer-content").css({
            height: window.innerHeight - 42,
            overflow: "scroll"
        })) : 1 == a.type && "" == a.area[1] && $(n)[0].offsetHeight >= window.innerHeight && $(n).find(".layui-layer-content")[0].offsetHeight < $(n).find(".layui-layer-content")[0].scrollHeight && ($(n.selector).css({
            height: window.innerHeight,
            top: 0
        }), $(n.selector).find(".layui-layer-close").removeClass("layui-layer-close2").addClass("layui-layer-close1"), $(n.selector).find(".layui-layer-content").css({'overflowY': 'auto'})), 1 == a.type, t.openLayer(), a.success && (2 == a.type ? n.find("iframe").on("load", function () {
            a.success(n, t.index)
        ...
        a.attr("minLeft"), l !== o.type[3] && l !== o.type[4] && (n || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - f - c <= 64 && (t.height = 64 + f + c)), a.css(t), c = a.find("." + s[6]).outerHeight(), l === o.type[2] ? a.find("iframe").css({height: parseFloat(t.height) - f - c}) : r.css({height: parseFloat(t.height) - f - c - parseFloat(r.css("padding-top")) - parseFloat(r.css("padding-bottom"))}))
    }, r.min = function (e, t) {
    ...
    r.prompt = function (e, t) {
        ...
        var l,
            s = 2 == e.formType ? '<textarea class="layui-layer-input"' + a + ">" + (e.value || "") + "</textarea>" : '<input type="' + (1 == e.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (e.value || "") + '">';
        return r.open(i.extend({
            type: 1,
            btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
            content: s,
        ...
        if (t = t || {}, t.photos) {
            ...
            if (l.imgIndex = 1 + (0 | u), t.img = t.img || "img", s) {
